...
```text
a160da346bb4238a96133d35609d75dfec738794
```

安装命令：

```bash
bash <(curl -fsSL https://raw.githubusercontent.com/AngKouChan/akvps/a160da346bb4238a96133d35609d75dfec738794/install.sh)
```
